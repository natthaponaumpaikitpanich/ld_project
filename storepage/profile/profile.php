...
<div class="container mt-4">
  ...
  <h4>  🏪 ข้อมูลร้าน</h4>
     ...
     <div class="card-body">
    <div class="container ">
<p><strong>ชื่อร้าน:</strong> <?= htmlspecialchars($store['store_name']) ?></p>
<p><strong>ที่อยู่:</strong> <?= htmlspecialchars($store['address']) ?></p>
<p><strong>เบอร์ร้าน:</strong> <?= htmlspecialchars($store['phone']) ?></p>
<p><strong>สถานะร้าน:</strong> <?= $store['status'] ?></p>
</div>
</div>
