                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <?php if ($s['sub_status'] === 'waiting_approve'): ?>
                                            ...
                                            <a href="billing/approve_action.php?id=<?= $s['sub_id'] ?>&action=approve" class="btn-action btn-edit" onclick="return confirm('อนุมัติการสมัคร?')">
                                                <i class="bi bi-check2-circle"></i> อนุมัติ
                                            </a>

                                            <a href="billing/approve_action.php?id=<?= $s['sub_id'] ?>&action=reject" class="btn-action btn-delete" onclick="return confirm('ปฏิเสธการสมัคร?')">
