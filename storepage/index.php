...
<title>ร้านซักอบรีด</title>
  <style>
    ...
    .bg-grad-orders {
      background: linear-gradient(135deg, #2097ffff, #52ebf3ff, #00ffa2ff);
    }
...
<body>
  ...
  <div class="container py-4">
    ...
    <div class="row g-1 mb-4">
      <div class="col-md-2">
        <a href="index.php?link=orders" class="btn btn-primary btn-lg quick-btn bg-grad-orders w-100 p-3">
          ออเดอร์ </a>
      </div>
      <div class="col-md-2">
        <a href="index.php?link=delivery" class="btn btn-primary btn-lg quick-btn bg-grad-delivery w-100 p-3">
          การจัดส่ง </a>
      </div>
      <div class="col-md-2">
        <a href="index.php?link=revenue" class="btn btn-success btn-lg quick-btn bg-grad-revenue w-100 p-3">
          รายได้ </a>

      </div>
      <div class="col-md-3">
        <a href="index.php?link=promotion" class="btn btn-dark btn-lg quick-btn bg-grad-promotion w-100 p-3">
          ประกาศโปรโมชั่น </a>
      </div>
      <div class="col-md-3">
...
<button class="issue-btn" data-bs-toggle="modal" data-bs-target="#issueModal">
    ⚠️
</button>
<!-- Issue Modal -->
